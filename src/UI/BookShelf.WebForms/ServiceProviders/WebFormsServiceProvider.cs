...
namespace BookShelf.WebForms.ServiceProviders
{
    public sealed class WebFormsServiceProvider : IServiceProvider
    {
        private readonly IServiceProvider _serviceProvider;

        public WebFormsServiceProvider(IServiceProvider serviceProvider)
        {
